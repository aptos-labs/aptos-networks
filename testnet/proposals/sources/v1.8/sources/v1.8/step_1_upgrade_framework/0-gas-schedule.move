// Script hash: 252a90d8 
// source commit hash: 920632983104c1f99ec996979d3d558132c03545
...
script {
    ...
    fun main(proposal_id: u64) {
        let framework_signer = aptos_governance::resolve_multi_step_proposal(
            ...
            vector[222u8,32u8,196u8,153u8,112u8,89u8,157u8,139u8,240u8,221u8,0u8,194u8,97u8,172u8,171u8,255u8,73u8,249u8,235u8,152u8,151u8,242u8,110u8,57u8,165u8,176u8,159u8,65u8,142u8,168u8,188u8,105u8,],
        );
        let gas_schedule_blob: vector<u8> = vector[
            ...
            0, 200, 23, 168, 4, 0, 0, 0, 14, 116, 120, 110, 46, 109, 97, 120, 95, 105, 111, 95,
            103, 97, 115, 0, 228, 11, 84, 2, 0, 0, 0, 19, 116, 120, 110, 46, 109, 97, 120, 95,
