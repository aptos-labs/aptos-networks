// Script hash: fde9af2a 
// source commit hash: 16a4ba6fc2514083e20ae3b6c23b588fdc84b26f
...
script {
    ...
    fun main(proposal_id: u64) {
        let framework_signer = aptos_governance::resolve_multi_step_proposal(
            ...
            vector[196u8,104u8,71u8,145u8,144u8,156u8,247u8,16u8,62u8,163u8,223u8,1u8,111u8,69u8,70u8,220u8,202u8,123u8,218u8,103u8,46u8,126u8,74u8,196u8,63u8,195u8,73u8,26u8,0u8,93u8,242u8,40u8,],
        );
